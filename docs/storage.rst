...
.. automodule:: datashaping.storage.dataset
   :members:

Updating collections
--------------------

:class:`~datashaping.storage.dataset.MemoryCollection` is primarily intended for
...
within a :class:`~datashaping.storage.dataset.MemoryCollection` instance, the
...
have to rebuild :class:`~datashaping.storage.dataset.MemoryCollection` index
...
:class:`~datashaping.storage.dataset.MemoryCollection` index (remove/add parts),
currently it's not the case.
Also remember to manually save :attr:`~datashaping.storage.dataset.MemoryCollection.data`
